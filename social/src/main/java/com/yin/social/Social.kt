package com.yin.social

import android.content.Context
import android.content.Intent
import android.graphics.Bitmap
import android.util.Log
import com.yin.social.callback.AuthCallback
import com.yin.social.callback.PayCallback
import com.yin.social.callback.ShareCallback
import com.yin.social.config.OperationType
import com.yin.social.config.PlatformType
import com.yin.social.config.SocialConstants
import com.yin.social.entity.content.*
import com.yin.social.entity.OperationBean
import com.yin.social.entity.platform.PlatformConfig
...
object Social {
  ...
  fun init(context: Context, vararg configs: PlatformConfig) {
    for (config in configs) {
      if (!config.appkey.isNullOrEmpty()) {
        if (!com.yin.social.PlatformManager.initPlat(context, config)) {
  ...
  fun available4Plat(type: PlatformType): Boolean {
    return com.yin.social.PlatformManager.availablePlatMap[type] != null
  }
  ...
  fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
    ...
    com.yin.social.PlatformManager.currentHandler?.let {
      Log.d("sociallib1", com.yin.social.PlatformManager.currentHandler.toString())
      com.yin.social.OperationManager.instance.performActivityResult(it, content)
    }
  }
  ...
  private fun performOperation(bean: OperationBean) {
    ...
    com.yin.social.OperationManager.instance.perform(bean)
  }
}